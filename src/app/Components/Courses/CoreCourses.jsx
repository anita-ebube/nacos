          ...
          >
            ...
            >
              ...
              <div className="flex justify-between">
                ...
                <div className="w-[50%]">
                  <h1 className="text-[2rem] font-bold mb-2">{props.title}</h1>
                  <span className="text-gray-600 block mb-4 text-xl">
                  {props.hint}
                  </span>
                  <p className="text-gray-700">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Tempora autem itaque amet vel nihil! Maxime doloremque cum
                    esse eius porro id molestiae distinctio molestias aut,
                    quibusdam recusandae dignissimos non suscipit! Lorem ipsum
                    dolor sit amet, consectetur adipisicing elit. Nesciunt,
                    dolorem hic. Quae voluptates harum molestiae qui quisquam,
                    ipsa, magnam delectus, sit repellendus dolorem vitae
                    aspernatur? Officiis eaque suscipit debitis. Maxime!
                  </p>
                </div>
              </div>
            </div>
